...
\begin{itemize}
    \item \textbf{$C_2$ reduction:} $\Delta n(C_2) = \CtwoDelta$.
    \item \textbf{$C_{\text{pinch}(ii)}$ reduction:} $\Delta n(C_{\text{pinch}(ii)}) = \PinchIIGadgetDelta$.
    \item \textbf{Refined $C_4$ reduction:} $\Delta n(\text{Refined } C_4) = \RefinedCfourDelta$.
\end{itemize}
