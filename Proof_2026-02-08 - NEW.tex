...
\subsection{$C_2$ --- \CtwoGadgetVertices-vertex gadget}
\label{app:rot-c2}
...
\subsection{Refined $C_4$ --- \RefinedCFourGadgetVertices-vertex gadget}
...
\subsection{$C_P$ ($=\mathrm{pinch}(ii)$) --- \PinchGadgetVertices-vertex gadget with flip bit}
\label{app:rot-pinch}
