...
rotation-system edit implementing the planar surgery, verify preservation of the class invariants (cubic, bipartite,
...
\bigskip
Requirement (CRF3) of the Certified Reduction Framework is thus satisfied by the checker's mandatory operational validation, ensuring that membership in $\mathcal{Q}$ is maintained throughout the reduction process.
...
identifications among terminals. The implication `topological occurrence $\Rightarrow$ certified occurrence' for $C_2$ and Pinch(ii) is discharged by the finite enumeration Lemma~\ref{lem:small-obstructions}, which proves that every certification failure occurs on at most 14 vertices.
...
Verified release: commit \texttt{821779f90e35e2946c0613338e45c285a9d130f2c} \\
