...
- `validate_in_Q(G)` checks cubicity, bipartiteness, and (optionally) 3-connectivity.
...
- 3-connectivity is intended to be preserved by the certified construction; optional checks exist.
